...
import { CustomCalendarPicker, ScrollPicker, useOnClickOutside } from "./CalendarPicker";
...
// useOnClickOutside + ScrollPicker now imported from ./CalendarPicker (shared with HeroEditor)
...
// CustomCalendarPicker moved to ./CalendarPicker (shared with HeroEditor)
